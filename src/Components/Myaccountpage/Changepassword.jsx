          ...
          <form onSubmit={handleSubmit}>
            {Object.keys(passwords).map((field, index) => (
              <div key={index} className='form-group col-lg-6 mb-2'>
                <label htmlFor={field} className='contactTitle form-label'>{field === 'currentPassword' ? 'Current Password' : field === 'newPassword' ? 'New Password' : 'Confirm New Password'}
                ...
                <div style={{ position: "relative" }}>
                  ...
                  />
                  <BsEyeFill
                    style={{ fontSize: "20px", color: "#A5A7A5", position: "absolute", top: "20px", right: "20px" , cursor:"pointer"}}
