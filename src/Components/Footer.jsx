...
import logo from "../../src/Images/Home/Header/Logo.png";
...
const Footer = () => {
  return (
    <>
      <section style={{paddingTop:" ", paddingBottom:" "}} className="" >
        <footer id="footer">
          <div className="footer-top">
            <div className="container">
              <div className="row  ">
                <div className="col-lg-5 col-sm-12 col-md-6 footer-links">
                  <div className="logoimg   " style={{marginLeft:"-16px"}}>
                    <img
                      className="img-fluid"
...
{/* company part */}
                <div className="  companypart col-lg-2 col-sm-5 col-md-6 footer-links order-lg-4 order-3">
                  <h6>Company</h6>
                  <ul>
                    <li>
                      <i className="bx bx-chevron-right"></i>{" "}
